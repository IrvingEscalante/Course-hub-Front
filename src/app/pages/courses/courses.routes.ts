...
import { PullRequestOwnerGuard } from "../../core/guards/pull-request-owner.guard";
...
export const COURSES_ROUTES: Routes = [
    ...
    {path: 'pull-request/:id', loadComponent: () => import('./pull-request-detail/pull-request-detail').then(m => m.PullRequestDetail), canActivate:[PullRequestOwnerGuard]},
